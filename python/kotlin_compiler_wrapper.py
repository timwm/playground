...
# @date: Fri, 05 Nov 2021 09:54:55 +0300
...
def myexit( code, error=None, stack=None ):
    if None is error:
        error = ": %d, exiting due to precious errors"% code 
    pformart("%s"% error, "\nError", colour='E')
    if stack:
...
def parse_arguments():
    ...
    EPILOG = "011's Kotlin Compiler Wrapper, Copyleft (c) 2021-present. License"\
        " GPLv3+: GNU GPL version 3 or later <http://gnu.org/licenses/gpl.html>"\
        " This is free software: you are free to change and redistribute it."\
        " There is NO WARRANTY, to the extent permitted by law.\nFor bug reporting"\
        " instructions, please see: https://resinst.cci.org/kcw/bugs\nOriginally"\
        " written by timon w. mesulam, Cactus Communications, PLLC."
